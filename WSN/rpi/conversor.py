...
#@details This module is used to convert the measures readed from serial port
...
#@details In a cycle sends every sensor of list to function "ajustar".
...
#@details From each sensor(Temperature,Humidity,Light) get the measure and aplicates a formul (from sensors datasheet)to get the real measure. 
